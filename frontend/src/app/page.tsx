  ...
  return (
    <div className="flex flex-col items-center justify-center flex-1 p-8 text-center space-y-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full max-w-4xl">
        <Link 
          href="/developer" 
          className="group relative rounded-xl border border-border bg-card p-8 hover:border-primary/50 hover:shadow-lg transition-all text-left flex flex-col gap-4"
        >
